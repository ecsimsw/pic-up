...
class MemberControllerUnitTest extends ControllerUnitTestContext {
    ...
    public void signInTest() throws Exception {
        ...
        var memberResponse = new MemberResponse(USER_ID, signInRequest.username());
        var loginUser = new LoginUser(memberResponse.id(), memberResponse.username());
    ...
    public void signUp() throws Exception {
        ...
        var memberResponse = new MemberResponse(1L, signUpRequest.username());
        var loginUser = new LoginUser(memberResponse.id(), memberResponse.username());
        var loginAuthToken = AuthTokens.of(loginUser, ACCESS_TOKEN, REFRESH_TOKEN);
