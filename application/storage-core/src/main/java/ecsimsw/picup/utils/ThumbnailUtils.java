...
public class ThumbnailUtils {
    ...
    public static ByteArrayOutputStream resize(InputStream input, String format, float scale) throws IOException {
    ...
    public static ByteArrayOutputStream capture(String videoFilePath, int frameNumber, String format) {
        try {
