...
kubectl port-forward -n picup service/member-server-svc 52082:8082 --address 0.0.0.0 & \
kubectl port-forward -n picup service/storage-server-svc 52083:8083 --address 0.0.0.0 & \
kubectl port-forward -n picup service/album-server-svc 52084:8084 --address 0.0.0.0 &
