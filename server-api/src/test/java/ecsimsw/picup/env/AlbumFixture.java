...
public class AlbumFixture {
    ...
    public static PictureInfoResponse PICTURE_INFO_RESPONSE = new PictureInfoResponse(USER_ID, ALBUM_ID, false, RESOURCE_KEY, THUMBNAIL_RESOURCE_KEY, LocalDateTime.now());
